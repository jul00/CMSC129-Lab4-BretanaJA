...
- Name: taskManager.spec.js >> Task Manager End-to-End Application User Stories >> User Story 3: Can delete a task from the list
- Location: tests\system\taskManager.spec.js:35:5
